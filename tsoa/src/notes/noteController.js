...
var notesService_1 = require("./notesService");
var db = require("./database.js");
var NotesController = /** @class */ (function (_super) {
    ...
    NotesController.prototype.getNotes = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new notesService_1.NotesService().getNotes()];
            });
        });
    };
    ...
    NotesController.prototype.insertNote = function (requestBody) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new notesService_1.NotesService().insertNote(requestBody)];
            });
        });
    };
    NotesController.prototype.updateNote = function (requestBody) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                new notesService_1.NotesService().updateNote(requestBody);
                return [2 /*return*/];
            });
        });
    };
